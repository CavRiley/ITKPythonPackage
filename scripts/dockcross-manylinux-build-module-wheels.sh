...
PRECOMPILED_ITK_BINARIES=${_ipp_dir}/ITK-cp310-cp310-manylinux_2_28_x64
...
CONTAINER_ITK_SOURCE_DIR=${CONTAINER_PACKAGE_BUILD_DIR}/ITK-source/ITK
...
CONTAINER_PRECOMPILED_BINARIES=${CONTAINER_WORK_DIR}/ITK-cp310-cp310-manylinux_2_28_x64
...
DOCKER_ARGS+=" -v ${PRECOMPILED_ITK_BINARIES}:${CONTAINER_PRECOMPILED_BINARIES} "
